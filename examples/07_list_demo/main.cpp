 ...
 *
 * ╔══════════════════════════════════════════════════════╗
 * ║          界面视觉结构（窗口 520×580 px）              ║
 * ╠══════════════════════════════════════════════════════╣
 * ║                                                      ║
 * ║  Text "title": "Virtual List 100K" (18px Bold)       ║
 * ║                                                      ║
 * ║  ┌──────────────────────────────────────┬──┐         ║
 * ║  │  List "list" (100,000 items, 400×420)│ ▐│←滚动条  ║
 * ║  │                                      │ ▐│         ║
 * ║  │  Item 0                              │ ▐│         ║
 * ║  │  Item 1                              │ ▐│         ║
 * ║  │  Item 2       ← 仅渲染~13个可见项     │ ▐│         ║
 * ║  │  Item 3        (虚拟滚动,itemH=32)    │ ▐│         ║
 * ║  │  Item 4                              │ ░│← 滑块   ║
 * ║  │  ...                                 │ ░│         ║
 * ║  │  Item 99,999                         │ ▐│         ║
 * ║  └──────────────────────────────────────┴──┘         ║
 * ║       ↑ 点击项高亮选中, 滚轮/拖拽滚动条翻页 ↑         ║
 * ║                                                      ║
 * ║  组件层级: root → [title, list]                      ║
 * ║  性能: 100K项仅渲染~13可见项, 滚动<1ms               ║
 * ╚══════════════════════════════════════════════════════╝
 */
